...
export function Ribbon(props: RibbonProps) {
  ...
  const [selectedValue, setSelectedValue] = React.useState<TabValue>('sales');
  ...
  return (
    <div className="ribbon">
      <TabList defaultSelectedValue="sales" onTabSelect={onTabSelect}>
        <Tab value="sales">Sales</Tab>
        <Tab value="about">Architecture</Tab>
      </TabList>
      {["sales"].includes(selectedValue as string) && 
