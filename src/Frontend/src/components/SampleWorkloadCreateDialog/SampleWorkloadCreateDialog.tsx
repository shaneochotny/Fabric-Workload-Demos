...
interface SaveAsDialogProps extends IPageProps {
...
export function SaveAsDialog({ workloadClient, isImmediateSave }: SaveAsDialogProps) {
    ...
    const sampleItemType = sampleWorkloadName + ".InvestmentInsights";
    const sampleItemDisplayName = "Investment Insights";
    const sampleItemEditorPath = "/investment-insights";
    const EMPTY_GUID = '00000000-0000-0000-0000-000000000000';

    const [displayName, setDisplayName] = useState<string>("Investment Insights");
    const [description, setDescription] = useState<string>("Investment Insights Dashboard");
