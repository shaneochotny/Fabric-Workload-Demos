...
namespace Boilerplate.Controllers
{
    ...
    public class LakehouseController : ControllerBase
    {
        ...
        private static readonly IList<string> FabricAPIScopes = new[] { $"{EnvironmentConstants.FabricApiBaseUrl}/.default" };
        ...
        private static readonly IList<string> ScopesForWriteWorkspace = new[] { WorkloadScopes.FabricWorkspaceReadWriteAll, WorkloadScopes.FabricLakehouseReadWriteAll };
        ...
        public async Task<IActionResult> GetLakehousesAsync(Guid workspaceId)
        {
            var authorizationContext = await _authenticationService.AuthenticateDataPlaneCall(_httpContextAccessor.HttpContext, allowedScopes: [WorkloadScopes.FabricWorkspaceReadWriteAll, WorkloadScopes.FabricLakehouseReadWriteAll]);
