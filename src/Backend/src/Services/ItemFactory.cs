    ...
    public class ItemFactory : IItemFactory
    {
        ...
        public IItem CreateItem(string itemType, AuthorizationContext authorizationContext)
        {
            switch (itemType)
            {
                ...
                case WorkloadConstants.ItemTypes.InvestmentInsights:
                    return new InvestmentInsights(_serviceProvider.GetService<ILogger<InvestmentInsights>>(), _itemMetadataStore, _lakeHouseClientService, _authenticationService, authorizationContext);
