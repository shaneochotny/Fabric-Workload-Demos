...
resource containerApps 'Microsoft.App/containerapps@2025-01-01' = {
  name: '${toLower(settings.environment)}copilot${toLower(settings.resourceNameSuffix)}-retailiq'
  ...
  properties: {
    ...
    template: {
      containers: [
        {
          image: '${containerRegistry.name}.azurecr.io/copilotretailiq:latest'
          ...
          env: [
            ...
            }
            {
              ...
              value: settings.copilots.retailIQ.eventhouseConnectionString
            }
            {
              name: 'EVENTHOUSE_DATABASE'
              value: settings.copilots.retailIQ.eventhouseDatabase
            }
            {
              name: 'LAKEHOUSE_CONNECTION_STRING'
              value: settings.copilots.retailIQ.lakehouseSQLConnectionString
            }
            {
              name: 'LAKEHOUSE_DATABASE'
              value: settings.copilots.retailIQ.lakehouseSQLDatabase
            }
            {
